  ...
  return (
    <div className="privacy-container">
      ...
      <div>
        ...
        <h3 className="terms-title">Definitions</h3>
        <p className="privacy-desc">For the purposes of this Privacy Policy:</p>
        <ul>
          ...
          <li className="privacy-pointers">
            {" "}
            <strong>Application</strong> refers to Aistra, the software program
            provided by the Company.
          </li>
          <li className="privacy-pointers">
            {" "}
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to Aistra Labs Inc.
          </li>
          <li className="privacy-pointers">
            {" "}
          ...
          <li className="privacy-pointers">
            {" "}
            <strong>Website</strong> refers to Aistra, accessible from
            www.aistra.com
          </li>
          <li className="privacy-pointers">
            {" "}
      ...
      <div>
        ...
        <ul>
          <li className="privacy-pointers">Email address</li>
      ...
      <div>
        <h3 className="terms-title">Tracking Technologies and Cookies</h3>
        <p className="privacy-desc">
      ...
      <div>
        ...
        <ul>
          ...
          <li className="privacy-pointers">
            ...
            bankruptcy, liquidation, or a similar proceeding, in which Personal
      ...
      <div>
        <h2 className="privacy-subHeading">Retention of Your Personal Data</h2>
        <p className="privacy-desc">
      ...
      <div>
        <h2 className="privacy-subHeading">Transfer of Your Personal Data</h2>
        <p className="privacy-desc">
      ...
      <div>
        <h2 className="privacy-subHeading">Delete Your Personal Data</h2>
        <p className="privacy-desc">
      ...
      <div>
        <h2 className="privacy-subHeading">Disclosure of Your Personal Data</h2>
        <h3 className="terms-title">Business Transactions</h3>
        <p className="privacy-desc">
        ...
        <h3 className="terms-title">Law Enforcement</h3>
        <p className="privacy-desc">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="terms-title">Other Legal Requirements</h3>
        <p className="privacy-desc">
        ...
        <ul>
          ...
          <li className="privacy-pointers">Protect against legal liability</li>
        </ul>
      </div>
      <div>
        <h2 className="privacy-subHeading">Children's Privacy</h2>
        <h2 className="privacy-subHeading">Security of Your Personal Data</h2>
        <p className="privacy-desc">
      ...
      <div>
        <h2 className="privacy-subHeading">Links to Other Websites</h2>
        <p className="privacy-desc">
