...
function PrivacyPolicy() {
  return (
    <div className='container'>
      <h1>Privacy Policy for Aistra</h1>
    <div>
     ...
     <h3>Definitions</h3>
      ...
      <ul>
          ...
          <li> <strong>Application</strong> refers to Aistra, the software program provided by the Company.</li>
          <li> <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Aistra Labs Inc.</li>
          ...
          <li> <strong>Website</strong> refers to Aistra, accessible from www.aistra.com</li>
    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <strong>To provide You with news, special offers, and general information about other goods, services, and events:</strong> which we offer that are similar to those that you have already purchased or inquired about unless You have opted not to receive such information.
        </li>
        <li>
    ...
    <div>
      ...
      <p>
        By email: <a href="mailto:info@aistra.com">info@aistra.com</a>
      </p>
    </div>
</div>
  );
